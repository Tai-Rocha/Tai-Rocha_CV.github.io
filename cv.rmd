...
<div style="text-align: justify"> I am a researcher working on patterns of biodiversity distribution, focusing on the impacts of global change (climate change and land-use and land-cover change). My recent interests and work including: __1.__ Analysis of climate data and land use and land cover data under different scenarios of climate change, __2.__ Spatial analysis of species diversity (alpha and beta diversity), __3.__ Ecological niche models/species distribution models and other niche analyses to assess the impacts of global change on biodiversity, __4.__ Biogeographic patterns and evolutionary history in the Neotropics. <br/> __Note:__ I use open-source tools and platforms. I am interested in good practices about open science (open databases, open software, etc.), good workflows, reproducibility and FAIR principles. </div>
...
### Regular expressions (regex) for data cleaning and transforming
