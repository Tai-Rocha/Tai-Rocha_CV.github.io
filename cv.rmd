...
```{r}
 if(params$pdf_mode){
  cat("[PDF version available here](https://github.com/Tai-Rocha/Tai-Rocha_CV.github.io/raw/main/Rocha_T_cv.pdf)")
  } else {
  cat("<i class='fas fa-download'></i> [Online version available here](https://tai-rocha.github.io/Tai-Rocha_CV.github.io)")
}
```
