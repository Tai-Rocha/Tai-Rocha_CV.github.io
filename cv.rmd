...
Member of Examination Committee  {data-icon=newspaper} 
--------------------------------------------------------------------------------
...
Talks & Scientific communication  {data-icon=bullhorn}
--------------------------------------------------------------------------------
::: aside
```{r}
...
Open Life Science program ([OLS-2](https://openlifesci.org/ols-2/projects-participants/#participants))       | [Slides](https://tai-rocha.github.io/OLS_2_Tai-Rocha.github.io/#1)

Virtual 

2020

### Challenges of digital transformation in teaching and research </b>Slides will soon available
...
Selected Events  {data-icon=address-card-o}
--------------------------------------------------------------------------------
